...
public class CustomerController {
    ...
    public GetCustomerByCitizenNumber getByCitizenNumber(
            @Valid @RequestParam @Parameter(description = "The citizen number of the customer") String citizenNumber) {
    ...
    public DeletedCustomerResponse delete(
            @Valid @RequestParam @Parameter(description = "The citizen number of the customer to be deleted") String citizenNumber) {
    ...
    public ChangedStatusCustomerResponse changeActiveStatus(
            @Valid @RequestParam @Parameter(description = "The citizen number of the customer whose status will be changed") String citizenNumber) {
